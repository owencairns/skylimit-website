...
<template>
    <div class="content-container">
        <h1 class="weddings-title">Weddings Gallery</h1>

        <swiper-container navigation="true" loop="true" autoplay-delay="2000" :slidesPerView="'auto'" :centeredSlides="true"
            :spaceBetween="0" :pagination="{
                clickable: true,
            }">
